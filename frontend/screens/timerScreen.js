...
import Project from "../models/projects"; // Assuming you have a Project model defined
...
export default function timerScreen() {
  ...
  const [tempWorkMinutes, setTempWorkMinutes] = useState(
    String(Math.floor(workTime / 60))
  );
  const [tempBreakMinutes, setTempBreakMinutes] = useState(
    String(Math.floor(breakTime / 60))
  );
...
const [isLoading, setIsLoading] = useState(false);
  ...
  >
      <Text style={[styles.header, { color: theme.text }]}>Focus Flow</Text>
        ...
        <View style={styles.progressBarContainer}>
          <View
            style={[
              ...
              {
                width: `${
                  (secondsLeft / (onBreak ? breakTime : workTime)) * 100
                }%`,
                backgroundColor: onBreak ? "#38D9A9" : "#4263EB",
              },
            ]}
      ...
      <View style={styles.buttonsContainer}>
        <TouchableOpacity
          style={[
            styles.button,
            { backgroundColor: isRunning ? "#FF6B6B" : "#38D9A9" },
          ]}
      ...
      <View style={[styles.projectCard, { backgroundColor: theme.surface }]}>
        <Text style={[styles.projectCardTitle, { color: theme.text }]}>
          Project Management
        </Text>
